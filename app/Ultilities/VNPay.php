...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "J5RB5EY9"; //Mã website tại VNPAY
    static $vnp_HashSecret = "AGRRXTCIQEREHXOVZSAADXHMCNZMUNDO"; //Chuỗi bí mật
...
//        $vnp_BankCode = 'NCB';
        ...
        return $returnData['data']; //chỉ lấy ra $vnp_Url.
    }
}
